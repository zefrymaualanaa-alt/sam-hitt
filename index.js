...
function generateWelcomeText(ctx) {
    ...
    return `<b>[ STARLIX  NETFLIX HIT ]</b>\n\n` +
...
bot.action('action_menu_bot', (ctx) => {
    ...
    const menuText = `<b>[ PUSAT KENDALI SISTEM ]</b>\n━━━━━━━━━━━━━━━━━━━━━\n\n` +
        `Berikut adalah modul perintah utama yang tersedia di sistem Starlix:\n\n` +
        `<b>🚀 Modul Eksekusi</b>\n` +
...
[Result] Terkumpul: ${allResults.length} / ${targetTotal} Sesi</pre>`;
        ...
        if (allResults.length > 0) {
            ...
            const summaryLayout = 
                ...
                `<i>Sistem telah menyelesaikan tugas dengan sukses. Jika Anda membutuhkan standarisasi format atau verifikasi live/dead lanjutan, silakan teruskan file output di bawah ini ke bot manajemen @starlixconvertbot agar diproses lebih lanjut.</i>`;
...
async function startBotWithRetry() {
    try { await bot.launch({ polling: { timeout: 30 } }); console.log('✅ Sistem Starlix Online & Beroperasi (Mode Terenkripsi)'); } 
